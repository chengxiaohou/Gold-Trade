...
function createDefaultStocks(): StockEntry[] {
  const stockData: Array<{ code: string; name: string; dividendByYear: Record<number, number> }> = [
    { code: '601318.SH', name: '中国平安', dividendByYear: { 2025: 2.7000, 2024: 2.5500, 2023: 2.4300, 2022: 2.4200, 2021: 2.3800, 2020: 2.2000, 2019: 2.0500, 2018: 1.9200, 2017: 1.5000, 2016: 0.7500, 2015: 0.5300, 2014: 0.7500, 2013: 0.6500, 2012: 0.4500, 2011: 0.4000, 2010: 0.5500, 2009: 0.4500, 2008: 0.2000, 2007: 0.7000, 2006: 0.2200 } },
    { code: '600036.SH', name: '招商银行', dividendByYear: { 2025: 2.0160, 2024: 2.0000, 2023: 1.9720, 2022: 1.7380, 2021: 1.5220, 2020: 1.2530, 2019: 1.2000, 2018: 0.9400, 2017: 0.8400, 2016: 0.7400, 2015: 0.6900, 2014: 0.6700, 2013: 0.6200, 2012: 0.6300, 2011: 0.4200, 2010: 0.2900, 2009: 0.2100, 2008: 0.1000, 2007: 0.2800, 2006: 0.3000, 2005: 0.0800, 2004: 0.1100, 2003: 0.0920, 2002: 0.1200 } },
    { code: '000333.SZ', name: '美的集团', dividendByYear: { 2025: 4.3000, 2024: 3.5000, 2023: 3.0000, 2022: 2.5000, 2021: 1.7009, 2020: 1.6006, 2019: 1.6000, 2018: 1.3040, 2017: 1.2000, 2016: 1.0000, 2015: 1.2000, 2014: 1.0000, 2013: 2.0000 } },
    { code: '600690.SH', name: '海尔智家', dividendByYear: { 2025: 1.1607, 2024: 0.9650, 2023: 0.8013, 2022: 0.5669, 2021: 0.4614, 2020: 0.3660, 2019: 0.3750, 2018: 0.3510, 2017: 0.3420, 2016: 0.2480, 2015: 0.2120, 2014: 0.4920, 2013: 0.4600, 2012: 0.3700, 2011: 0.1700, 2010: 0.1000, 2009: 0.3000, 2008: 0.1500, 2007: 0.2000, 2006: 0.1500, 2005: 0.1000, 2004: 0.3000, 2003: 0.0500, 2002: 0.3000, 2001: 0.3000, 2000: 0.2000, 1999: 0.2000, 1997: 0.4700, 1996: 0.4300, 1995: 0.1000, 1994: 0.3500 } },
    { code: '000858.SZ', name: '五粮液', dividendByYear: { 2025: 5.1577, 2024: 5.7450, 2023: 4.6700, 2022: 3.7820, 2021: 3.0230, 2020: 2.5800, 2019: 2.2000, 2018: 1.7000, 2017: 1.3000, 2016: 0.9000, 2015: 0.8000, 2014: 0.6000, 2013: 0.7000, 2012: 0.8000, 2011: 0.5000, 2010: 0.3000, 2009: 0.1500, 2008: 0.0500, 2006: 0.0600, 2005: 0.1000, 2003: 0.2000, 2001: 0.1250, 1998: 1.2500 } },
    { code: '000568.SZ', name: '泸州老窖', dividendByYear: { 2025: 5.7750, 2024: 5.9500, 2023: 5.4001, 2022: 4.2250, 2021: 3.2440, 2020: 2.0510, 2019: 1.5900, 2018: 1.5500, 2017: 1.2500, 2016: 0.9600, 2015: 0.8000, 2014: 0.8000, 2013: 1.2500, 2012: 1.8000, 2011: 1.4000, 2010: 1.0000, 2009: 0.7500, 2008: 0.6500, 2007: 0.5600, 2006: 0.3500, 2005: 0.0400, 2004: 0.0400, 2003: 0.0600, 2002: 0.1500, 2001: 0.2500, 1999: 0.4600, 1997: 0.3000, 1996: 0.5000, 1995: 0.6000, 1994: 0.8500 } },
    { code: '600887.SH', name: '伊利股份', dividendByYear: { 2025: 1.3800, 2024: 1.2200, 2023: 1.2000, 2022: 1.0400, 2021: 0.9600, 2020: 0.8200, 2019: 0.8100, 2018: 0.7000, 2017: 0.7000, 2016: 0.6000, 2015: 0.4500, 2014: 0.8000, 2013: 0.8000, 2012: 0.2800, 2011: 0.2500, 2006: 0.1000, 2005: 0.2600, 2004: 0.2500, 2003: 0.3300, 2002: 0.2000, 2001: 0.3600, 2000: 0.3500, 1999: 0.2800, 1998: 0.2600, 1997: 0.2500, 1996: 0.1250 } },
  ];
  
  return stockData.map((item, index) => {
    const div2024 = item.dividendByYear[2024] || 0;
    const div2025 = item.dividendByYear[2025] || 0;
    return {
      id: (index + 1).toString(),
      code: item.code,
      name: item.name,
      ...
      dividendByYear: item.dividendByYear,
      dividendRate2025: 0,
      positionShares: 0,
      positionCost: 0,
      priceUpdatedAt: null,
